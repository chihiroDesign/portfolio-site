...
function getHoverClass(icon: string) {
  switch (icon) {
    case "linkedin": return "hover:text-[#0A66C2]";
    case "note": return "hover:text-[#41C9B4]";
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          {profileData.socialLinks.map((link) => {
            ...
            return (
              <a
                ...
                className={`text-white/30 ${getHoverClass(link.icon || "")} transition-colors`}
          ...
          <span className="text-xs text-white/20 ml-2">
            &copy; {new Date().getFullYear()} chihiro Design. All rights reserved.
          </span>
        </div>
      </div>
    </footer>
